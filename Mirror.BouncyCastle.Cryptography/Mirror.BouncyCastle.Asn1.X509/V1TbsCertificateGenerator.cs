...
public class V1TbsCertificateGenerator
{
	...
	public TbsCertificateStructure GenerateTbsCertificate()
	{
		...
		return TbsCertificateStructure.GetInstance(new DerSequence(serialNumber, signature, issuer, new DerSequence(startDate, endDate), subject, subjectPublicKeyInfo));
	}
}
