...
public class TbsCertificateStructure : Asn1Encodable
{
	...
	public static TbsCertificateStructure GetInstance(object obj)
	{
		...
		if (obj is TbsCertificateStructure result)
		{
			return result;
		}
	...
	private TbsCertificateStructure(Asn1Sequence seq)
	{
		...
		{
			version = DerInteger.GetInstance(taggedObject, declaredExplicit: true);
		}
		else
		{
			num = -1;
		...
		while (num2 > 0)
		{
			...
			case 3:
				...
				extensions = X509Extensions.GetInstance(Asn1Sequence.GetInstance(instance, declaredExplicit: true));
				break;
			default:
	...
	{
		string environmentVariable = Platform.GetEnvironmentVariable("Mirror.BouncyCastle.X509.Allow_Non-DER_TBSCert");
