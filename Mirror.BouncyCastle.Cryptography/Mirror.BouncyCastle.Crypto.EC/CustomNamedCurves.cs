...
public static class CustomNamedCurves
{
	...
	internal class SecP160K1Holder : X9ECParametersHolder
	{
		...
		protected override ECCurve CreateCurve()
		{
			...
			return ConfigureCurveGlv(new SecP160K1Curve(), p);
		}
	...
	internal class SecP192K1Holder : X9ECParametersHolder
	{
		...
		protected override ECCurve CreateCurve()
		{
			...
			return ConfigureCurveGlv(new SecP192K1Curve(), p);
		}
	...
	internal class SecP224K1Holder : X9ECParametersHolder
	{
		...
		protected override ECCurve CreateCurve()
		{
			...
			return ConfigureCurveGlv(new SecP224K1Curve(), p);
		}
	...
	internal class SecP256K1Holder : X9ECParametersHolder
	{
		...
		protected override ECCurve CreateCurve()
		{
			...
			return ConfigureCurveGlv(new SecP256K1Curve(), p);
		}
