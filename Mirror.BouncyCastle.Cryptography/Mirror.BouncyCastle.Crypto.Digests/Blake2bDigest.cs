...
public sealed class Blake2bDigest : IDigest
{
	...
	private void Compress(byte[] message, int messagePos)
	{
		...
		for (int i = 0; i < 12; i++)
		{
			G(array[blake2b_sigma[i, 0]], array[blake2b_sigma[i, 1]], 0, 4, 8, 12);
			G(array[blake2b_sigma[i, 2]], array[blake2b_sigma[i, 3]], 1, 5, 9, 13);
			G(array[blake2b_sigma[i, 4]], array[blake2b_sigma[i, 5]], 2, 6, 10, 14);
			G(array[blake2b_sigma[i, 6]], array[blake2b_sigma[i, 7]], 3, 7, 11, 15);
			G(array[blake2b_sigma[i, 8]], array[blake2b_sigma[i, 9]], 0, 5, 10, 15);
			G(array[blake2b_sigma[i, 10]], array[blake2b_sigma[i, 11]], 1, 6, 11, 12);
			G(array[blake2b_sigma[i, 12]], array[blake2b_sigma[i, 13]], 2, 7, 8, 13);
			G(array[blake2b_sigma[i, 14]], array[blake2b_sigma[i, 15]], 3, 4, 9, 14);
		}
