...
public class SignedData : Asn1Encodable
{
	...
	private SignedData(Asn1Sequence seq)
	{
		...
		enumerator.MoveNext();
		digestAlgorithms = (Asn1Set)enumerator.Current.ToAsn1Object();
		enumerator.MoveNext();
		contentInfo = ContentInfo.GetInstance(enumerator.Current.ToAsn1Object());
	...
	public override Asn1Object ToAsn1Object()
	{
		...
		if (certificates != null)
		{
			if (certsBer)
			{
				asn1EncodableVector.Add(new BerTaggedObject(isExplicit: false, 0, certificates));
			}
			else
			{
				asn1EncodableVector.Add(new DerTaggedObject(isExplicit: false, 0, certificates));
			}
		}
		if (crls != null)
		{
			if (crlsBer)
			{
				asn1EncodableVector.Add(new BerTaggedObject(isExplicit: false, 1, crls));
			}
			else
			{
				asn1EncodableVector.Add(new DerTaggedObject(isExplicit: false, 1, crls));
			}
		}
