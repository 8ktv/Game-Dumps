...
public class F2mPoint : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		case 0:
		{
			...
			return new F2mPoint(curve, eCFieldElement31, y3);
		}
		case 1:
		{
			...
			return new F2mPoint(curve, x, y2, new ECFieldElement[1] { eCFieldElement27 });
		}
		case 6:
		{
			if (rawXCoord.IsZero)
			...
			if (rawXCoord2.IsZero)
			{
				...
				{
					return new F2mPoint(curve, eCFieldElement10, curve.B.Sqrt());
				}
			...
			return new F2mPoint(curve, eCFieldElement10, y, new ECFieldElement[1] { eCFieldElement11 });
		}
		default:
	...
	public override ECPoint Twice()
	{
		...
		case 1:
		{
			...
			return new F2mPoint(curve, x2, y2, new ECFieldElement[1] { eCFieldElement19 });
		}
		case 6:
		{
			ECFieldElement rawYCoord = base.RawYCoord;
			...
			{
				return new F2mPoint(curve, eCFieldElement5, curve.B.Sqrt());
			}
			...
			return new F2mPoint(curve, eCFieldElement6, eCFieldElement9, new ECFieldElement[1] { eCFieldElement7 });
		}
		default:
			throw new InvalidOperationException("unsupported coordinate system");
		}
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		if (curve.CoordinateSystem == 6)
		{
			...
			return new F2mPoint(curve, x2, y, new ECFieldElement[1] { eCFieldElement8 });
		}
		return Twice().Add(b);
	}
	...
	public override ECPoint Negate()
	{
		...
		case 0:
		{
			...
			return new F2mPoint(curve, rawXCoord, rawYCoord4.Add(rawXCoord));
		}
		case 1:
		{
			ECFieldElement rawYCoord3 = base.RawYCoord;
			ECFieldElement eCFieldElement2 = base.RawZCoords[0];
			return new F2mPoint(curve, rawXCoord, rawYCoord3.Add(rawXCoord), new ECFieldElement[1] { eCFieldElement2 });
		}
		case 5:
		{
			ECFieldElement rawYCoord2 = base.RawYCoord;
			return new F2mPoint(curve, rawXCoord, rawYCoord2.AddOne());
		}
		case 6:
		{
			ECFieldElement rawYCoord = base.RawYCoord;
			ECFieldElement eCFieldElement = base.RawZCoords[0];
			return new F2mPoint(curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1] { eCFieldElement });
		}
		default:
			throw new InvalidOperationException("unsupported coordinate system");
		}
