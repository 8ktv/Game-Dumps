...
public class FpPoint : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		case 0:
		{
			...
			return new FpPoint(Curve, eCFieldElement31, y3);
		}
		case 1:
		{
			...
			return new FpPoint(curve, x, y2, new ECFieldElement[1] { eCFieldElement27 });
		}
		case 2:
		case 4:
		{
			...
			return new FpPoint(curve, eCFieldElement7, y, zs);
		}
		default:
	...
	public override ECPoint Twice()
	{
		...
		case 0:
		{
			...
			return new FpPoint(Curve, eCFieldElement10, y2);
		}
		case 1:
		{
			...
			return new FpPoint(curve, x5, y3, new ECFieldElement[1] { eCFieldElement19 });
		}
		case 2:
		{
			ECFieldElement eCFieldElement = base.RawZCoords[0];
			...
			if (eCFieldElement3.ToBigInteger().Equals(BigInteger.ValueOf(3)))
			{
			...
			return new FpPoint(curve, eCFieldElement7, y, new ECFieldElement[1] { eCFieldElement8 });
		}
		case 4:
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		case 0:
		{
			...
			return new FpPoint(Curve, eCFieldElement7, y);
		}
		case 4:
	...
	public override ECPoint TimesPow2(int e)
	{
		...
		case 0:
		{
			...
			return new FpPoint(curve, eCFieldElement3.Multiply(eCFieldElement12), eCFieldElement.Multiply(b));
		}
		case 1:
			eCFieldElement3 = eCFieldElement3.Multiply(eCFieldElement4);
			eCFieldElement4 = eCFieldElement4.Multiply(eCFieldElement4.Square());
			return new FpPoint(curve, eCFieldElement3, eCFieldElement, new ECFieldElement[1] { eCFieldElement4 });
		case 2:
			return new FpPoint(curve, eCFieldElement3, eCFieldElement, new ECFieldElement[1] { eCFieldElement4 });
		case 4:
			return new FpPoint(curve, eCFieldElement3, eCFieldElement, new ECFieldElement[2] { eCFieldElement4, eCFieldElement2 });
		default:
			throw new InvalidOperationException("unsupported coordinate system");
		}
	}
	...
	public override ECPoint Negate()
	{
		...
		{
			return new FpPoint(curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
		}
		return new FpPoint(curve, base.RawXCoord, base.RawYCoord.Negate());
	}
	...
	protected virtual FpPoint TwiceJacobianModified(bool calculateW)
	{
		...
		return new FpPoint(Curve, eCFieldElement6, y, new ECFieldElement[2] { eCFieldElement9, eCFieldElement8 });
	}
}
