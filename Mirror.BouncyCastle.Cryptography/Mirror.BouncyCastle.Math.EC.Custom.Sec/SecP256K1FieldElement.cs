...
internal class SecP256K1FieldElement : AbstractFpFieldElement
{
	...
	public override ECFieldElement Sqrt()
	{
		...
		SecP256K1Field.Square(y, array, tt);
		SecP256K1Field.Multiply(array, y, array, tt);
		uint[] array2 = Nat256.Create();
		SecP256K1Field.Square(array, array2, tt);
		SecP256K1Field.Multiply(array2, y, array2, tt);
		uint[] array3 = Nat256.Create();
		SecP256K1Field.SquareN(array2, 3, array3, tt);
		SecP256K1Field.Multiply(array3, array2, array3, tt);
		uint[] array4 = array3;
		SecP256K1Field.SquareN(array3, 3, array4, tt);
		SecP256K1Field.Multiply(array4, array2, array4, tt);
		uint[] array5 = array4;
		SecP256K1Field.SquareN(array4, 2, array5, tt);
		SecP256K1Field.Multiply(array5, array, array5, tt);
		uint[] array6 = Nat256.Create();
		SecP256K1Field.SquareN(array5, 11, array6, tt);
		SecP256K1Field.Multiply(array6, array5, array6, tt);
		uint[] array7 = array5;
		SecP256K1Field.SquareN(array6, 22, array7, tt);
		SecP256K1Field.Multiply(array7, array6, array7, tt);
		uint[] array8 = Nat256.Create();
		SecP256K1Field.SquareN(array7, 44, array8, tt);
		SecP256K1Field.Multiply(array8, array7, array8, tt);
		uint[] z = Nat256.Create();
		SecP256K1Field.SquareN(array8, 88, z, tt);
		SecP256K1Field.Multiply(z, array8, z, tt);
		uint[] z2 = array8;
		SecP256K1Field.SquareN(z, 44, z2, tt);
		SecP256K1Field.Multiply(z2, array7, z2, tt);
		uint[] array9 = array7;
		SecP256K1Field.SquareN(z2, 3, array9, tt);
		SecP256K1Field.Multiply(array9, array2, array9, tt);
		uint[] z3 = array9;
		SecP256K1Field.SquareN(z3, 23, z3, tt);
		SecP256K1Field.Multiply(z3, array6, z3, tt);
		SecP256K1Field.SquareN(z3, 6, z3, tt);
		SecP256K1Field.Multiply(z3, array, z3, tt);
		SecP256K1Field.SquareN(z3, 2, z3, tt);
		uint[] array10 = array;
		SecP256K1Field.Square(z3, array10, tt);
