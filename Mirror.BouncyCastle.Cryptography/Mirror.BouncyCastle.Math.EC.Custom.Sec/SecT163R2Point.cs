...
internal class SecT163R2Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		if (rawXCoord2.IsZero)
		{
			...
			{
				return new SecT163R2Point(curve, eCFieldElement10, curve.B.Sqrt());
			}
		...
		return new SecT163R2Point(curve, eCFieldElement10, y, new ECFieldElement[1] { eCFieldElement11 });
	}
	...
	public override ECPoint Twice()
	{
		...
		{
			return new SecT163R2Point(curve, eCFieldElement3, curve.B.Sqrt());
		}
		...
		return new SecT163R2Point(curve, eCFieldElement4, y, new ECFieldElement[1] { eCFieldElement5 });
	}
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		if (eCFieldElement4.IsZero)
		{
			return new SecT163R2Point(curve, eCFieldElement4, curve.B.Sqrt());
		}
		...
		return new SecT163R2Point(curve, x2, y, new ECFieldElement[1] { eCFieldElement7 });
	}
	...
	public override ECPoint Negate()
	{
		...
		ECFieldElement rawYCoord = base.RawYCoord;
		ECFieldElement eCFieldElement = base.RawZCoords[0];
		return new SecT163R2Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1] { eCFieldElement });
	}
}
