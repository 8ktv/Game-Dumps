...
internal class SecT571R1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecT571R1Point(curve, secT571FieldElement7, secT571FieldElement8, new ECFieldElement[1] { secT571FieldElement9 });
	}
	...
	public override ECPoint Twice()
	{
		...
		{
			return new SecT571R1Point(curve, new SecT571FieldElement(array5), SecT571R1Curve.SecT571R1_B_SQRT);
		}
		...
		return new SecT571R1Point(curve, secT571FieldElement4, y2, new ECFieldElement[1] { secT571FieldElement5 });
	}
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		return new SecT571R1Point(curve, x2, y, new ECFieldElement[1] { eCFieldElement7 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecT571R1Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1] { eCFieldElement });
	}
}
