...
internal class SecP256K1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		{
			array6 = array3;
			SecP256K1Field.Square(secP256K1FieldElement5.x, array6, tt);
			array5 = array2;
			SecP256K1Field.Multiply(array6, secP256K1FieldElement3.x, array5, tt);
			SecP256K1Field.Multiply(array6, secP256K1FieldElement5.x, array6, tt);
			SecP256K1Field.Multiply(array6, secP256K1FieldElement4.x, array6, tt);
		}
		...
		{
			array8 = array4;
			SecP256K1Field.Square(secP256K1FieldElement6.x, array8, tt);
			array7 = array;
			SecP256K1Field.Multiply(array8, secP256K1FieldElement.x, array7, tt);
			SecP256K1Field.Multiply(array8, secP256K1FieldElement6.x, array8, tt);
			SecP256K1Field.Multiply(array8, secP256K1FieldElement2.x, array8, tt);
		}
		...
		uint[] array11 = array3;
		SecP256K1Field.Square(array9, array11, tt);
		uint[] array12 = Nat256.Create();
		SecP256K1Field.Multiply(array11, array9, array12, tt);
		uint[] array13 = array3;
		SecP256K1Field.Multiply(array11, array7, array13, tt);
		...
		SecP256K1Field.Square(array10, secP256K1FieldElement7.x, tt);
		...
		if (!isOne)
		{
			SecP256K1Field.Multiply(secP256K1FieldElement9.x, secP256K1FieldElement5.x, secP256K1FieldElement9.x, tt);
		}
		if (!isOne2)
		{
			SecP256K1Field.Multiply(secP256K1FieldElement9.x, secP256K1FieldElement6.x, secP256K1FieldElement9.x, tt);
		}
		ECFieldElement[] zs = new ECFieldElement[1] { secP256K1FieldElement9 };
		return new SecP256K1Point(curve, secP256K1FieldElement7, secP256K1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		SecP256K1Field.Square(secP256K1FieldElement.x, array, tt);
		uint[] array2 = Nat256.Create();
		SecP256K1Field.Square(array, array2, tt);
		uint[] array3 = Nat256.Create();
		SecP256K1Field.Square(secP256K1FieldElement2.x, array3, tt);
		SecP256K1Field.Reduce32(Nat256.AddBothTo(array3, array3, array3), array3);
		uint[] array4 = array;
		SecP256K1Field.Multiply(array, secP256K1FieldElement2.x, array4, tt);
		...
		SecP256K1Field.Square(array3, secP256K1FieldElement4.x, tt);
		...
		SecP256K1Field.Multiply(secP256K1FieldElement5.x, array3, secP256K1FieldElement5.x, tt);
		...
		{
			SecP256K1Field.Multiply(secP256K1FieldElement6.x, secP256K1FieldElement3.x, secP256K1FieldElement6.x, tt);
		}
		return new SecP256K1Point(curve, secP256K1FieldElement4, secP256K1FieldElement5, new ECFieldElement[1] { secP256K1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP256K1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
