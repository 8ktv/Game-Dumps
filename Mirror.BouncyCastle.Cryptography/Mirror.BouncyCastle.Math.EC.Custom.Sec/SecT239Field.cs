...
internal static class SecT239Field
{
	...
	public static void Sqrt(ulong[] x, ulong[] z)
	{
		...
		ulong num2 = Interleave.Unshuffle(x[2], x[3], out var even2);
		ulong num3 = num2 >> 49;
		ulong num4 = (num >> 49) | (num2 << 15);
		num2 ^= num << 15;
		ulong[] array = Nat256.CreateExt64();
		...
		{
			int num5 = array2[i] >> 6;
			int num6 = array2[i] & 0x3F;
			array[num5] ^= num << num6;
			array[num5 + 1] ^= (num2 << num6) | (num >> -num6);
			array[num5 + 2] ^= (num4 << num6) | (num2 >> -num6);
			array[num5 + 3] ^= (num3 << num6) | (num4 >> -num6);
			array[num5 + 4] ^= num3 >> -num6;
		}
		Reduce(array, z);
		z[0] ^= even;
		z[1] ^= even2;
