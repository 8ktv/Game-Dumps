...
internal class SecP256R1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		{
			array6 = array3;
			SecP256R1Field.Square(secP256R1FieldElement5.x, array6, tt);
			array5 = array2;
			SecP256R1Field.Multiply(array6, secP256R1FieldElement3.x, array5, tt);
			SecP256R1Field.Multiply(array6, secP256R1FieldElement5.x, array6, tt);
			SecP256R1Field.Multiply(array6, secP256R1FieldElement4.x, array6, tt);
		}
		...
		{
			array8 = array4;
			SecP256R1Field.Square(secP256R1FieldElement6.x, array8, tt);
			array7 = array;
			SecP256R1Field.Multiply(array8, secP256R1FieldElement.x, array7, tt);
			SecP256R1Field.Multiply(array8, secP256R1FieldElement6.x, array8, tt);
			SecP256R1Field.Multiply(array8, secP256R1FieldElement2.x, array8, tt);
		}
		...
		uint[] array11 = array3;
		SecP256R1Field.Square(array9, array11, tt);
		uint[] array12 = Nat256.Create();
		SecP256R1Field.Multiply(array11, array9, array12, tt);
		uint[] array13 = array3;
		SecP256R1Field.Multiply(array11, array7, array13, tt);
		...
		SecP256R1Field.Square(array10, secP256R1FieldElement7.x, tt);
		...
		if (!isOne)
		{
			SecP256R1Field.Multiply(secP256R1FieldElement9.x, secP256R1FieldElement5.x, secP256R1FieldElement9.x, tt);
		}
		if (!isOne2)
		{
			SecP256R1Field.Multiply(secP256R1FieldElement9.x, secP256R1FieldElement6.x, secP256R1FieldElement9.x, tt);
		}
		ECFieldElement[] zs = new ECFieldElement[1] { secP256R1FieldElement9 };
		return new SecP256R1Point(curve, secP256R1FieldElement7, secP256R1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		SecP256R1Field.Square(array6, secP256R1FieldElement4.x, tt);
		...
		SecP256R1Field.Multiply(secP256R1FieldElement5.x, array6, secP256R1FieldElement5.x, tt);
		...
		if (!isOne)
		{
			SecP256R1Field.Multiply(secP256R1FieldElement6.x, secP256R1FieldElement3.x, secP256R1FieldElement6.x, tt);
		}
		return new SecP256R1Point(curve, secP256R1FieldElement4, secP256R1FieldElement5, new ECFieldElement[1] { secP256R1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP256R1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
