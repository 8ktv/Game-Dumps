...
internal class SecP160R1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecP160R1Point(curve, secP160R1FieldElement7, secP160R1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SecP160R1Point(curve, secP160R1FieldElement4, secP160R1FieldElement5, new ECFieldElement[1] { secP160R1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP160R1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
