...
internal class SecP160R2Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecP160R2Point(curve, secP160R2FieldElement7, secP160R2FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SecP160R2Point(curve, secP160R2FieldElement4, secP160R2FieldElement5, new ECFieldElement[1] { secP160R2FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP160R2Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
