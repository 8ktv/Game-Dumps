...
public sealed class AutoExposure : PostProcessEffectSettings
{
	...
	{
		if (enabled.value && SystemInfo.supportsComputeShaders && !RuntimeUtilities.isOpenGLES && !RuntimeUtilities.isWebNonWebGPU && RenderTextureFormat.RFloat.IsSupported() && (bool)context.resources.computeShaders.autoExposure)
		{
