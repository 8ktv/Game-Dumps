...
internal sealed class ScreenSpaceReflectionsRenderer : PostProcessEffectRenderer<ScreenSpaceReflections>
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		{
			num >>= 1;
			command.GetTemporaryRT(m_MipIDs[j], num, num, 0, FilterMode.Bilinear, defaultHDRRenderTextureFormat, RenderTextureReadWrite.Default, 1, enableRandomWrite: true);
		...
		command.BlitFullscreenTriangle(context.source, context.destination, propertySheet, 3, clear: false, null, preserveDepth: true);
