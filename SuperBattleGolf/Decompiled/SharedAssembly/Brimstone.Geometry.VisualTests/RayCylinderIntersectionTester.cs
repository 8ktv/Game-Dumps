...
public class RayCylinderIntersectionTester : MonoBehaviour
{
	[SerializeField]
	...
	private void Update()
	{
		...
		if (!(forward == Vector3.zero))
		{
			...
			int num = BGeo.RayCylinderIntersection(base.transform.position, forward, cylinder.transform.position, cylinder.transform.up, cylinder.radius, out closeIntersection, out farIntersection);
