...
{
	public static readonly string Version = "1.2.785";
	...
	internal static DateTime lastQuittingTime;
	...
	internal static bool isQuitting
	{
		get
		{
			...
			if (Time.frameCount >= 0 && _isQuittingFrame != Time.frameCount && (DateTime.Now - lastQuittingTime).TotalSeconds > 2.0)
			{
