	...
	public static SubjectPublicKeyInfo CreateSubjectPublicKeyInfo(AsymmetricKeyParameter publicKey)
	{
		...
		if (publicKey is ECPublicKeyParameters)
		{
			...
			if (eCPublicKeyParameters.PublicKeyParamSet == null)
			{
				...
				x962Parameters = new X962Parameters(new X9ECParameters(parameters6.Curve, new X9ECPoint(parameters6.G, compressed: false), parameters6.N, parameters6.H, parameters6.GetSeed()));
			}
			else
			{
