...
internal class Adrs
{
	internal static uint WOTS_HASH = 0u;

	internal static uint WOTS_PK = 1u;

	internal static uint TREE = 2u;

	internal static uint FORS_TREE = 3u;

	internal static uint FORS_PK = 4u;

	internal static uint WOTS_PRF = 5u;

	internal static uint FORS_PRF = 6u;
	...
	internal void SetAdrsType(uint adrsType)
	{
		...
		Arrays.Fill(value, OFFSET_TYPE + 4, value.Length, 0);
	}
