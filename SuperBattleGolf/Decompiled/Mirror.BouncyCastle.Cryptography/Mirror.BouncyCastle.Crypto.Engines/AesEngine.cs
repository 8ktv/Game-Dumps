...
public sealed class AesEngine : IBlockCipher
{
	...
	private void EncryptBlock(byte[] input, int inOff, byte[] output, int outOff, uint[][] KW)
	{
		...
		{
			array = KW[num9++];
			num10 = T0[num5 & 0xFF] ^ Shift(T0[(num6 >> 8) & 0xFF], 24) ^ Shift(T0[(num7 >> 16) & 0xFF], 16) ^ Shift(T0[(num8 >> 24) & 0xFF], 8) ^ array[0];
			num11 = T0[num6 & 0xFF] ^ Shift(T0[(num7 >> 8) & 0xFF], 24) ^ Shift(T0[(num8 >> 16) & 0xFF], 16) ^ Shift(T0[(num5 >> 24) & 0xFF], 8) ^ array[1];
			num12 = T0[num7 & 0xFF] ^ Shift(T0[(num8 >> 8) & 0xFF], 24) ^ Shift(T0[(num5 >> 16) & 0xFF], 16) ^ Shift(T0[(num6 >> 24) & 0xFF], 8) ^ array[2];
			num8 = T0[num8 & 0xFF] ^ Shift(T0[(num5 >> 8) & 0xFF], 24) ^ Shift(T0[(num6 >> 16) & 0xFF], 16) ^ Shift(T0[(num7 >> 24) & 0xFF], 8) ^ array[3];
			array = KW[num9++];
			num5 = T0[num10 & 0xFF] ^ Shift(T0[(num11 >> 8) & 0xFF], 24) ^ Shift(T0[(num12 >> 16) & 0xFF], 16) ^ Shift(T0[(num8 >> 24) & 0xFF], 8) ^ array[0];
			num6 = T0[num11 & 0xFF] ^ Shift(T0[(num12 >> 8) & 0xFF], 24) ^ Shift(T0[(num8 >> 16) & 0xFF], 16) ^ Shift(T0[(num10 >> 24) & 0xFF], 8) ^ array[1];
			num7 = T0[num12 & 0xFF] ^ Shift(T0[(num8 >> 8) & 0xFF], 24) ^ Shift(T0[(num10 >> 16) & 0xFF], 16) ^ Shift(T0[(num11 >> 24) & 0xFF], 8) ^ array[2];
			num8 = T0[num8 & 0xFF] ^ Shift(T0[(num10 >> 8) & 0xFF], 24) ^ Shift(T0[(num11 >> 16) & 0xFF], 16) ^ Shift(T0[(num12 >> 24) & 0xFF], 8) ^ array[3];
		}
		array = KW[num9++];
		num10 = T0[num5 & 0xFF] ^ Shift(T0[(num6 >> 8) & 0xFF], 24) ^ Shift(T0[(num7 >> 16) & 0xFF], 16) ^ Shift(T0[(num8 >> 24) & 0xFF], 8) ^ array[0];
		num11 = T0[num6 & 0xFF] ^ Shift(T0[(num7 >> 8) & 0xFF], 24) ^ Shift(T0[(num8 >> 16) & 0xFF], 16) ^ Shift(T0[(num5 >> 24) & 0xFF], 8) ^ array[1];
	...
	private void DecryptBlock(byte[] input, int inOff, byte[] output, int outOff, uint[][] KW)
	{
		...
		{
			array = KW[num9--];
			num10 = Tinv0[num5 & 0xFF] ^ Shift(Tinv0[(num8 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num7 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num6 >> 24) & 0xFF], 8) ^ array[0];
			num11 = Tinv0[num6 & 0xFF] ^ Shift(Tinv0[(num5 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num8 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num7 >> 24) & 0xFF], 8) ^ array[1];
			num12 = Tinv0[num7 & 0xFF] ^ Shift(Tinv0[(num6 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num5 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num8 >> 24) & 0xFF], 8) ^ array[2];
			num8 = Tinv0[num8 & 0xFF] ^ Shift(Tinv0[(num7 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num6 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num5 >> 24) & 0xFF], 8) ^ array[3];
			array = KW[num9--];
			num5 = Tinv0[num10 & 0xFF] ^ Shift(Tinv0[(num8 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num12 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num11 >> 24) & 0xFF], 8) ^ array[0];
			num6 = Tinv0[num11 & 0xFF] ^ Shift(Tinv0[(num10 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num8 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num12 >> 24) & 0xFF], 8) ^ array[1];
			num7 = Tinv0[num12 & 0xFF] ^ Shift(Tinv0[(num11 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num10 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num8 >> 24) & 0xFF], 8) ^ array[2];
			num8 = Tinv0[num8 & 0xFF] ^ Shift(Tinv0[(num12 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num11 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num10 >> 24) & 0xFF], 8) ^ array[3];
		}
		array = KW[1];
		num10 = Tinv0[num5 & 0xFF] ^ Shift(Tinv0[(num8 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num7 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num6 >> 24) & 0xFF], 8) ^ array[0];
		num11 = Tinv0[num6 & 0xFF] ^ Shift(Tinv0[(num5 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num8 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num7 >> 24) & 0xFF], 8) ^ array[1];
		...
		num8 = Tinv0[num8 & 0xFF] ^ Shift(Tinv0[(num7 >> 8) & 0xFF], 24) ^ Shift(Tinv0[(num6 >> 16) & 0xFF], 16) ^ Shift(Tinv0[(num5 >> 24) & 0xFF], 8) ^ array[3];
		array = KW[0];
		num = (uint)(Si[num10 & 0xFF] ^ (s[(num8 >> 8) & 0xFF] << 8) ^ (s[(num12 >> 16) & 0xFF] << 16) ^ (Si[(num11 >> 24) & 0xFF] << 24)) ^ array[0];
		num2 = (uint)(s[num11 & 0xFF] ^ (s[(num10 >> 8) & 0xFF] << 8) ^ (Si[(num8 >> 16) & 0xFF] << 16) ^ (s[(num12 >> 24) & 0xFF] << 24)) ^ array[1];
		num3 = (uint)(s[num12 & 0xFF] ^ (Si[(num11 >> 8) & 0xFF] << 8) ^ (Si[(num10 >> 16) & 0xFF] << 16) ^ (s[(num8 >> 24) & 0xFF] << 24)) ^ array[2];
		int n = Si[num8 & 0xFF] ^ (s[(num12 >> 8) & 0xFF] << 8) ^ (s[(num11 >> 16) & 0xFF] << 16) ^ (s[(num10 >> 24) & 0xFF] << 24) ^ (int)array[3];
		Pack.UInt32_To_LE(num, output, outOff);
		Pack.UInt32_To_LE(num2, output, outOff + 4);
		Pack.UInt32_To_LE(num3, output, outOff + 8);
		Pack.UInt32_To_LE((uint)n, output, outOff + 12);
