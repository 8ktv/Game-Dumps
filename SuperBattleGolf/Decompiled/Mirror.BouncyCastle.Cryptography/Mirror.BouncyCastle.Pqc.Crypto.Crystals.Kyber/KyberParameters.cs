...
public sealed class KyberParameters : IKemParameters, ICipherParameters
{
	public static KyberParameters kyber512 = new KyberParameters("kyber512", 2, 256, usingAes: false);

	public static KyberParameters kyber768 = new KyberParameters("kyber768", 3, 256, usingAes: false);
	...
	public static KyberParameters kyber512_aes = new KyberParameters("kyber512-aes", 2, 256, usingAes: true);

	[Obsolete("Parameter set to be removed")]
	public static KyberParameters kyber768_aes = new KyberParameters("kyber768-aes", 3, 256, usingAes: true);
