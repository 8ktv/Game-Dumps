...
internal static class Ntt
{
	...
	internal static void NTT(short[] r)
	{
		int num = 0;
		int num2 = 1;
		for (int num3 = 128; num3 >= 2; num3 >>= 1)
		{
			for (int num4 = 0; num4 < 256; num4 = num + num3)
			{
				...
				{
					short num5 = FactorQMulMont(a, r[num + num3]);
					r[num + num3] = (short)(r[num] - num5);
					r[num] += num5;
				}
			}
		}
	...
	internal static void InvNTT(short[] r)
	{
		...
		for (int num3 = 2; num3 <= 128; num3 <<= 1)
		{
			for (int num4 = 0; num4 < 256; num4 = num + num3)
			{
				...
				{
					short num5 = r[num];
					r[num] = Reduce.BarrettReduce((short)(num5 + r[num + num3]));
					r[num + num3] = (short)(num5 - r[num + num3]);
	...
	internal static void BaseMult(short[] r, int off, short a0, short a1, short b0, short b1, short zeta)
	{
		...
		a2 += FactorQMulMont(a0, b0);
		r[off] = a2;
		short num = FactorQMulMont(a0, b1);
		num += FactorQMulMont(a1, b0);
		r[off + 1] = num;
	}
}
