...
public class CertTemplate : Asn1Encodable
{
	...
	private CertTemplate(Asn1Sequence seq)
	{
		...
		foreach (Asn1TaggedObject item in seq)
		{
			...
			{
			case 0:
				version = DerInteger.GetInstance(item, declaredExplicit: false);
				break;
			case 1:
				serialNumber = DerInteger.GetInstance(item, declaredExplicit: false);
				break;
			case 2:
			...
			case 3:
				...
				break;
			case 4:
				validity = OptionalValidity.GetInstance(Asn1Sequence.GetInstance(item, declaredExplicit: false));
				break;
			case 5:
			...
			case 8:
				...
				break;
			case 9:
				extensions = X509Extensions.GetInstance(item, declaredExplicit: false);
				break;
			default:
