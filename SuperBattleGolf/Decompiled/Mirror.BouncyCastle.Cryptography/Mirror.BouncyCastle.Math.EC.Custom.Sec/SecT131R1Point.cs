...
internal class SecT131R1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		if (rawXCoord2.IsZero)
		{
			...
			{
				return new SecT131R1Point(curve, eCFieldElement10, curve.B.Sqrt());
			}
		...
		return new SecT131R1Point(curve, eCFieldElement10, y, new ECFieldElement[1] { eCFieldElement11 });
	}
	...
	public override ECPoint Twice()
	{
		...
		{
			return new SecT131R1Point(curve, eCFieldElement3, curve.B.Sqrt());
		}
		...
		return new SecT131R1Point(curve, eCFieldElement4, y, new ECFieldElement[1] { eCFieldElement5 });
	}
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		if (eCFieldElement5.IsZero)
		{
			return new SecT131R1Point(curve, eCFieldElement5, curve.B.Sqrt());
		}
		...
		return new SecT131R1Point(curve, x2, y, new ECFieldElement[1] { eCFieldElement8 });
	}
	...
	public override ECPoint Negate()
	{
		...
		ECFieldElement rawYCoord = base.RawYCoord;
		ECFieldElement eCFieldElement = base.RawZCoords[0];
		return new SecT131R1Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1] { eCFieldElement });
	}
}
