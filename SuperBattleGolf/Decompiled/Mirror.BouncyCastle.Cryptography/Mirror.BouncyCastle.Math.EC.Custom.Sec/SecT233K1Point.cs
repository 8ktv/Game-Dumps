...
internal class SecT233K1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		{
			if (secT233FieldElement2.IsZero)
			{
				return curve.Infinity;
			}
			return b.Add(this);
		}
		SecT233FieldElement secT233FieldElement3 = (SecT233FieldElement)base.RawYCoord;
		...
		SecT233FieldElement secT233FieldElement6 = (SecT233FieldElement)b.RawZCoords[0];
		ulong[] array = Nat256.CreateExt64();
		ulong[] array2 = Nat256.Create64();
		ulong[] array3 = Nat256.Create64();
		ulong[] array4 = Nat256.Create64();
		bool isOne = secT233FieldElement4.IsOne;
		if (isOne)
		{
			Nat256.Copy64(secT233FieldElement2.x, array2);
			Nat256.Copy64(secT233FieldElement5.x, array3);
		}
		else
		{
			SecT233Field.Multiply(secT233FieldElement2.x, secT233FieldElement4.x, array2);
			SecT233Field.Multiply(secT233FieldElement5.x, secT233FieldElement4.x, array3);
		}
		bool isOne2 = secT233FieldElement6.IsOne;
		if (isOne2)
		{
			Nat256.Copy64(secT233FieldElement.x, array4);
			Nat256.Copy64(secT233FieldElement3.x, array);
		}
		else
		{
			SecT233Field.Multiply(secT233FieldElement.x, secT233FieldElement6.x, array4);
			SecT233Field.Multiply(secT233FieldElement3.x, secT233FieldElement6.x, array);
		}
		SecT233Field.AddTo(array, array3);
		SecT233Field.Add(array4, array2, array);
		...
		if (secT233FieldElement2.IsZero)
		{
			...
			secT233FieldElement = (SecT233FieldElement)eCPoint.XCoord;
			ECFieldElement yCoord = eCPoint.YCoord;
			ECFieldElement b2 = secT233FieldElement5;
			ECFieldElement eCFieldElement = yCoord.Add(b2).Divide(secT233FieldElement);
			ECFieldElement eCFieldElement2 = eCFieldElement.Square().Add(eCFieldElement).Add(secT233FieldElement);
			if (eCFieldElement2.IsZero)
			{
				return new SecT233K1Point(curve, eCFieldElement2, curve.B);
			}
			ECFieldElement y = eCFieldElement.Multiply(secT233FieldElement.Add(eCFieldElement2)).Add(eCFieldElement2).Add(yCoord)
				.Divide(eCFieldElement2)
				.Add(eCFieldElement2);
			ECFieldElement eCFieldElement3 = curve.FromBigInteger(BigInteger.One);
			return new SecT233K1Point(curve, eCFieldElement2, y, new ECFieldElement[1] { eCFieldElement3 });
		}
		SecT233Field.Square(array, array);
		SecT233Field.Multiply(array4, array3, array4);
		SecT233Field.Multiply(array2, array3, array2);
		ulong[] array5 = array4;
		SecT233Field.Multiply(array5, array2, array5);
		if (Nat256.IsZero64(array5))
		{
			return new SecT233K1Point(curve, new SecT233FieldElement(array5), curve.B);
		}
		ulong[] array6 = array3;
		SecT233Field.Multiply(array6, array, array6);
		if (!isOne2)
		{
			SecT233Field.Multiply(array6, secT233FieldElement6.x, array6);
		}
		ulong[] array7 = array2;
		SecT233Field.AddTo(array, array7);
		SecT233Field.SquareExt(array7, array);
		SecT233Field.Add(secT233FieldElement3.x, secT233FieldElement4.x, array7);
		SecT233Field.MultiplyAddToExt(array6, array7, array);
		SecT233Field.Reduce(array, array7);
		if (!isOne)
		{
			SecT233Field.Multiply(array6, secT233FieldElement4.x, array6);
		}
		return new SecT233K1Point(curve, new SecT233FieldElement(array5), new SecT233FieldElement(array7), new ECFieldElement[1]
		{
			new SecT233FieldElement(array6)
		});
	}
	...
	public override ECPoint Twice()
	{
		...
		{
			return new SecT233K1Point(curve, eCFieldElement3, curve.B);
		}
		...
		ECFieldElement y = eCFieldElement6.Add(eCFieldElement3).Add(eCFieldElement2).Multiply(eCFieldElement6)
			...
			.Add(eCFieldElement4)
			.Add(eCFieldElement5);
		return new SecT233K1Point(curve, eCFieldElement4, y, new ECFieldElement[1] { eCFieldElement5 });
	}
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		if (eCFieldElement6.IsZero)
		{
			return new SecT233K1Point(curve, eCFieldElement6, curve.B);
		}
		...
		return new SecT233K1Point(curve, x2, y, new ECFieldElement[1] { eCFieldElement9 });
	}
	...
	public override ECPoint Negate()
	{
		...
		ECFieldElement rawYCoord = base.RawYCoord;
		ECFieldElement eCFieldElement = base.RawZCoords[0];
		return new SecT233K1Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1] { eCFieldElement });
	}
}
