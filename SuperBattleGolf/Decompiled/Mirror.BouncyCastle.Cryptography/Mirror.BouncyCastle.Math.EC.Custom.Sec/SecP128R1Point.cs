...
internal class SecP128R1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecP128R1Point(curve, secP128R1FieldElement7, secP128R1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SecP128R1Point(curve, secP128R1FieldElement4, secP128R1FieldElement5, new ECFieldElement[1] { secP128R1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP128R1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
