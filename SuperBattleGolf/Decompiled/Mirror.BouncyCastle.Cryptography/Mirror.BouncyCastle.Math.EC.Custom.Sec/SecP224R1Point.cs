...
internal class SecP224R1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecP224R1Point(curve, secP224R1FieldElement7, secP224R1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SecP224R1Point(curve, secP224R1FieldElement4, secP224R1FieldElement5, new ECFieldElement[1] { secP224R1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP224R1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
