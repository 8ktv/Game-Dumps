...
internal class SecP384R1FieldElement : AbstractFpFieldElement
{
	...
	public override ECFieldElement Sqrt()
	{
		...
		SecP384R1Field.Square(y, array, tt);
		SecP384R1Field.Multiply(array, y, array, tt);
		SecP384R1Field.SquareN(array, 2, array2, tt);
		SecP384R1Field.Multiply(array2, array, array2, tt);
		SecP384R1Field.Square(array2, array2, tt);
		SecP384R1Field.Multiply(array2, y, array2, tt);
		SecP384R1Field.SquareN(array2, 5, array3, tt);
		SecP384R1Field.Multiply(array3, array2, array3, tt);
		SecP384R1Field.SquareN(array3, 5, array4, tt);
		SecP384R1Field.Multiply(array4, array2, array4, tt);
		SecP384R1Field.SquareN(array4, 15, array2, tt);
		SecP384R1Field.Multiply(array2, array4, array2, tt);
		SecP384R1Field.SquareN(array2, 2, array3, tt);
		SecP384R1Field.Multiply(array, array3, array, tt);
		SecP384R1Field.SquareN(array3, 28, array3, tt);
		SecP384R1Field.Multiply(array2, array3, array2, tt);
		SecP384R1Field.SquareN(array2, 60, array3, tt);
		SecP384R1Field.Multiply(array3, array2, array3, tt);
		uint[] z = array2;
		SecP384R1Field.SquareN(array3, 120, z, tt);
		SecP384R1Field.Multiply(z, array3, z, tt);
		SecP384R1Field.SquareN(z, 15, z, tt);
		SecP384R1Field.Multiply(z, array4, z, tt);
		SecP384R1Field.SquareN(z, 33, z, tt);
		SecP384R1Field.Multiply(z, array, z, tt);
		SecP384R1Field.SquareN(z, 64, z, tt);
		SecP384R1Field.Multiply(z, y, z, tt);
		SecP384R1Field.SquareN(z, 30, array, tt);
		SecP384R1Field.Square(array, array2, tt);
