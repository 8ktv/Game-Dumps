...
internal class SecT571K1Point : AbstractF2mPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		if (secT571FieldElement2.IsZero)
		{
			...
			{
				return new SecT571K1Point(curve, secT571FieldElement7, curve.B);
			}
		...
		else
		{
			...
			SecT571Field.SquareExt(array4, array12);
		...
		return new SecT571K1Point(curve, secT571FieldElement7, secT571FieldElement8, new ECFieldElement[1] { secT571FieldElement9 });
	}
	...
	public override ECPoint Twice()
	{
		...
		{
			return new SecT571K1Point(curve, eCFieldElement3, curve.B);
		}
		...
		ECFieldElement y = eCFieldElement6.Add(eCFieldElement3).Add(eCFieldElement2).Multiply(eCFieldElement6)
			...
			.Add(eCFieldElement4)
			.Add(eCFieldElement5);
		return new SecT571K1Point(curve, eCFieldElement4, y, new ECFieldElement[1] { eCFieldElement5 });
	}
	...
	public override ECPoint TwicePlus(ECPoint b)
	{
		...
		if (eCFieldElement6.IsZero)
		{
			return new SecT571K1Point(curve, eCFieldElement6, curve.B);
		}
		...
		return new SecT571K1Point(curve, x2, y, new ECFieldElement[1] { eCFieldElement9 });
	}
	...
	public override ECPoint Negate()
	{
		...
		ECFieldElement rawYCoord = base.RawYCoord;
		ECFieldElement eCFieldElement = base.RawZCoords[0];
		return new SecT571K1Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1] { eCFieldElement });
	}
}
