...
internal class SecP192K1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecP192K1Point(curve, secP192K1FieldElement7, secP192K1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SecP192K1Point(curve, secP192K1FieldElement4, secP192K1FieldElement5, new ECFieldElement[1] { secP192K1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP192K1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
