...
internal class SecP192R1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SecP192R1Point(curve, secP192R1FieldElement7, secP192R1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SecP192R1Point(curve, secP192R1FieldElement4, secP192R1FieldElement5, new ECFieldElement[1] { secP192R1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP192R1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
