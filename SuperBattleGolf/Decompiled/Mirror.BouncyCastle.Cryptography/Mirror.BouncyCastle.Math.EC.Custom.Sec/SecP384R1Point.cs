...
internal class SecP384R1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		{
			array6 = array3;
			SecP384R1Field.Square(secP384R1FieldElement5.x, array6, tt);
			array5 = array2;
			SecP384R1Field.Multiply(array6, secP384R1FieldElement3.x, array5, tt);
			SecP384R1Field.Multiply(array6, secP384R1FieldElement5.x, array6, tt);
			SecP384R1Field.Multiply(array6, secP384R1FieldElement4.x, array6, tt);
		}
		...
		{
			array8 = array4;
			SecP384R1Field.Square(secP384R1FieldElement6.x, array8, tt);
			array7 = array;
			SecP384R1Field.Multiply(array8, secP384R1FieldElement.x, array7, tt);
			SecP384R1Field.Multiply(array8, secP384R1FieldElement6.x, array8, tt);
			SecP384R1Field.Multiply(array8, secP384R1FieldElement2.x, array8, tt);
		}
		...
		uint[] array11 = array3;
		SecP384R1Field.Square(array9, array11, tt);
		uint[] array12 = Nat.Create(12);
		SecP384R1Field.Multiply(array11, array9, array12, tt);
		uint[] array13 = array3;
		SecP384R1Field.Multiply(array11, array7, array13, tt);
		...
		SecP384R1Field.Square(array10, secP384R1FieldElement7.x, tt);
		...
		if (!isOne)
		{
			SecP384R1Field.Multiply(secP384R1FieldElement9.x, secP384R1FieldElement5.x, secP384R1FieldElement9.x, tt);
		}
		if (!isOne2)
		{
			SecP384R1Field.Multiply(secP384R1FieldElement9.x, secP384R1FieldElement6.x, secP384R1FieldElement9.x, tt);
		}
		ECFieldElement[] zs = new ECFieldElement[1] { secP384R1FieldElement9 };
		return new SecP384R1Point(curve, secP384R1FieldElement7, secP384R1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		SecP384R1Field.Square(array6, secP384R1FieldElement4.x, tt);
		...
		SecP384R1Field.Multiply(secP384R1FieldElement5.x, array6, secP384R1FieldElement5.x, tt);
		...
		if (!isOne)
		{
			SecP384R1Field.Multiply(secP384R1FieldElement6.x, secP384R1FieldElement3.x, secP384R1FieldElement6.x, tt);
		}
		return new SecP384R1Point(curve, secP384R1FieldElement4, secP384R1FieldElement5, new ECFieldElement[1] { secP384R1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SecP384R1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
