...
public class Holder : Asn1Encodable
{
	...
	{
		if (obj is Holder result)
		{
			return result;
		}
		if (obj is Asn1Sequence seq)
		{
			return new Holder(seq);
		}
		if (obj is Asn1TaggedObject tagObj)
		{
			return new Holder(tagObj);
		}
	...
	public Holder(Asn1TaggedObject tagObj)
	{
		...
		{
		case 0:
			baseCertificateID = IssuerSerial.GetInstance(tagObj, explicitly: true);
			break;
		case 1:
			entityName = GeneralNames.GetInstance(tagObj, explicitly: true);
			break;
		default:
	...
	public override Asn1Object ToAsn1Object()
	{
		...
		if (entityName != null)
		{
			return new DerTaggedObject(isExplicit: true, 1, entityName);
		}
		return new DerTaggedObject(isExplicit: true, 0, baseCertificateID);
	}
}
