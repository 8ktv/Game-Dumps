...
public class GeneralSubtree : Asn1Encodable
{
	...
	private GeneralSubtree(Asn1Sequence seq)
	{
		...
		case 2:
		{
			...
			{
			case 0:
				minimum = DerInteger.GetInstance(instance3, declaredExplicit: false);
				break;
			case 1:
				maximum = DerInteger.GetInstance(instance3, declaredExplicit: false);
				break;
			default:
		...
		case 3:
		{
			...
			minimum = DerInteger.GetInstance(instance, declaredExplicit: false);
			...
			maximum = DerInteger.GetInstance(instance2, declaredExplicit: false);
			break;
		}
		default:
	...
	public override Asn1Object ToAsn1Object()
	{
		...
		{
			asn1EncodableVector.Add(new DerTaggedObject(isExplicit: false, 0, minimum));
		}
