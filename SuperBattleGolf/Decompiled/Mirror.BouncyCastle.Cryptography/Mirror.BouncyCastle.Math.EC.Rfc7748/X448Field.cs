...
public static class X448Field
{
	...
	private static void Decode224(uint[] x, int xOff, uint[] z, int zOff)
	{
		...
		z[zOff + 1] = ((num >> 28) | (num2 << 4)) & 0xFFFFFFF;
		z[zOff + 2] = ((num2 >> 24) | (num3 << 8)) & 0xFFFFFFF;
		z[zOff + 3] = ((num3 >> 20) | (num4 << 12)) & 0xFFFFFFF;
		z[zOff + 4] = ((num4 >> 16) | (num5 << 16)) & 0xFFFFFFF;
		z[zOff + 5] = ((num5 >> 12) | (num6 << 20)) & 0xFFFFFFF;
		z[zOff + 6] = ((num6 >> 8) | (num7 << 24)) & 0xFFFFFFF;
		z[zOff + 7] = num7 >> 4;
	}
