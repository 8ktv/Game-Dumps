...
internal class SM2P256V1Point : AbstractFpPoint
{
	...
	public override ECPoint Add(ECPoint b)
	{
		...
		return new SM2P256V1Point(curve, sM2P256V1FieldElement7, sM2P256V1FieldElement8, zs);
	}
	...
	public override ECPoint Twice()
	{
		...
		return new SM2P256V1Point(curve, sM2P256V1FieldElement4, sM2P256V1FieldElement5, new ECFieldElement[1] { sM2P256V1FieldElement6 });
	}
	...
	public override ECPoint Negate()
	{
		...
		return new SM2P256V1Point(Curve, base.RawXCoord, base.RawYCoord.Negate(), base.RawZCoords);
	}
}
