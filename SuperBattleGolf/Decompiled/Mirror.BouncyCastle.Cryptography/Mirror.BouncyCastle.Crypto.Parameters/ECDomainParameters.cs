...
public class ECDomainParameters
{
	...
	public BigInteger HInv => Objects.EnsureSingletonInitialized(ref hInv, this, (ECDomainParameters self) => BigIntegers.ModOddInverseVar(self.n, self.h));
	...
	{
		return ((((0x404 ^ curve.GetHashCode()) * 257) ^ g.GetHashCode()) * 257) ^ n.GetHashCode();
	}
