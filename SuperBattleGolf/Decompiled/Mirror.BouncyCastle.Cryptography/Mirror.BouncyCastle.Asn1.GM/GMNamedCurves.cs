...
public static class GMNamedCurves
{
	internal class SM2P256V1Holder : X9ECParametersHolder
	{
		...
		protected override ECCurve CreateCurve()
		{
			...
			BigInteger order = FromHex("FFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFF7203DF6B21C6052B53BBF40939D54123");
	...
	internal class WapiP192V1Holder : X9ECParametersHolder
	{
		...
		protected override ECCurve CreateCurve()
		{
			...
			BigInteger order = FromHex("BDB6F4FE3E8B1D9E0DA8C0D40FC962195DFAE76F56564677");
			BigInteger one = BigInteger.One;
			return ConfigureCurve(new FpCurve(q, a, b, order, one, isInternal: true));
		}
