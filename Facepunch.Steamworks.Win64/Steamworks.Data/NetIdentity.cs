...
public struct NetIdentity
{
	...
	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingIdentity_SetPSNID")]
	internal static extern void InternalSetPSNID(ref NetIdentity self, ulong id);

	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingIdentity_GetPSNID")]
	...
	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingIdentity_SetIPv4Addr")]
	internal static extern void InternalSetIPv4Addr(ref NetIdentity self, uint nIPv4, ushort nPort);

	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingIdentity_GetIPv4")]
	internal static extern uint InternalGetIPv4(ref NetIdentity self);

	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingIdentity_GetFakeIPType")]
	internal static extern SteamNetworkingFakeIPType InternalGetFakeIPType(ref NetIdentity self);

	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingIdentity_IsFakeIP")]
	[return: MarshalAs(UnmanagedType.I1)]
