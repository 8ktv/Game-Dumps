...
public class Error
{
	public static string String(RESULT errcode)
	{
		return errcode switch
		{
			...
			RESULT.ERR_INTERNAL => "An error occured in the FMOD system. Use the logging version of FMOD for more information.", 
			...
			RESULT.ERR_PLUGIN_RESOURCE => "A resource that the plugin requires cannot be allocated or found. (ie the DLS file for MIDI playback)", 
